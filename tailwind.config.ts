  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        'gradient-tier-gold': 'var(--gradient-tier-gold)',
        'gradient-tier-platinum': 'var(--gradient-tier-platinum)',
        'gradient-tier-free': 'var(--gradient-tier-free)',
        'gradient-tier-silver': 'var(--gradient-tier-silver)',
      },
      keyframes: {
        'accordion-down': {
          from: { height: '0' },
