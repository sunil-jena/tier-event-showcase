        ...
        <div className='relative z-10 text-center text-white max-w-4xl mx-auto px-4'>
          <div className='animate-fade-in'>
            ...
            <p className='text-xl md:text-2xl mb-8 text-gray-200 max-w-2xl mx-auto'>
              Access exclusive events tailored to your tier. Level up your
              skills with curated experiences.
            </p>
        ...
        <div className='container mx-auto px-4'>
          <div className='text-center mb-16'>
            ...
            <p className='text-xl text-muted-foreground max-w-2xl mx-auto'>
              Experience curated events designed for your skill level and
              professional growth
            </p>
          </div>
          ...
          <div className='grid md:grid-cols-3 gap-8 mb-20'>
            <Card className='shadow-card hover:shadow-float transition-all duration-300 hover:-translate-y-1'>
              <CardContent className='p-8 text-center'>
                ...
                <p className='text-muted-foreground'>
                  Hand-picked events by industry experts
                </p>
              </CardContent>
            </Card>
            ...
            <Card className='shadow-card hover:shadow-float transition-all duration-300 hover:-translate-y-1'>
              <CardContent className='p-8 text-center'>
                ...
                <p className='text-muted-foreground'>
                  Advance through tiers as you grow
                </p>
              </CardContent>
            </Card>
          </div>
